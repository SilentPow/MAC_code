...
set "input_dir=.\MAC_web\full_videos\ad"
rem Directory to store HLS output
set "output_dir=.\MAC_web\videos\ad"
...
for %%f in ("%input_dir%\*.mp4") do (
    ...
    ffmpeg -i "%%f" -codec: copy -start_number 0 -hls_time 2 -hls_list_size 0 -f hls -sc_threshold 0 "%output_dir%\!filename!.m3u8"
